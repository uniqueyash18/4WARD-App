        ...
        <View style={styles.container}>
            <View style={styles.topcontainer}>
                ...
                <View style={styles.password}>
                    <InputComp placeholder={StringContants.Password} onPress={showpass} Show="Show" hide={show} value={password} onchange={(val) => { SetPassword(val) }} />
                    <InputComp placeholder={StringContants.Password} onPress={showConfirmpass} Show="Show" hide={showconfirm} value={Confirmpassword} onchange={(val) => { SetConfrimPassword(val) }} />
                </View>
