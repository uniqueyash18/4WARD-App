...
export default InitialScreen = ({navigation}) => {
    return (
        <View style={styles.container}>
            ...
            <View>
                <ButtonComp title={StringContants.LogIn_Phone_No} onPress={()=>{navigation.navigate(NavigationStrings.LOGIN)}} />
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate(NavigationStrings.SIGNUP)}} style={styles.bottomtext}>
